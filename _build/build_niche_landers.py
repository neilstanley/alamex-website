  ...
  <header class="header" id="header">
    <div class="container header__inner">
      ...
      <nav class="nav" id="nav" aria-label="Main navigation">
        ...
        <a href="../../google-ads.html" class="nav__link nav__link--active">Google Ads</a>
  ...
  <section class="page-header">
    <div class="container">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: var(--space-md); margin-top: var(--space-xl);">
        ...
        <a href="../../contact.html?intent=starter" class="btn btn--white btn--lg">Start Starter &mdash; &pound;750 setup</a>
        <!-- TODO: calendar - point at the real booking URL (/book-strategy-call) once it exists -->
        <a href="../../contact.html?intent=strategy-call" class="btn btn--outline btn--lg" style="border-color: rgba(255,255,255,0.35); color: #fff;">Book a &pound;99 strategy call</a>
      </div>
